...
def index():
    ...
    return render_template('index.html', story=story, button_name1=button_name1, button_name2=button_name2)
...
def submit():
    ...
    return render_template('index.html', story=story_text, button_name1=choice1_text, button_name2=choice2_text)
